...
public class YelpBusinessSearchRequestBuilderTest {
    ...
    private YelpBusinessSearchRequestBuilder underTest =
            new YelpBusinessSearchRequestBuilder("https://localhost:12311/v3", sender);
    ...
    public void canBuildRequestWithOptionalParameters() {
        ...
        verify(sender).getRequest("https://localhost:12311/v3/businesses/search?offset=12&limit=50&location=london" +
                        "&term=food&categories=bars,french&radius=2000&locale=plaistow",
                BusinessSearchResult.class, someToken);
    }
}